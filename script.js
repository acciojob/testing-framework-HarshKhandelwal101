...
//your code here
function describe(testSuiteName, func) { console.log(`beginning test suite ${testSuiteName}`);
try {
func();
console.log(`successfully completed test suite ${testSuiteName}`);
} catch (error) { const {testCaseName, errorMessage} = error; console.error(
...
try {func();
    ...
    function expect(actual) { return new ExpectFunctions (actual)};
    function ExpectFunctions (actual) { this.actual = actual;
